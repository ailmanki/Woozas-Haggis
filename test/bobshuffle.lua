...
local function asymmetryCompare(oldAsymmetry, t1, t2)
	...
	local h1 = unhappiness(t1, "marine")
	local h2 = unhappiness(t2, "alien")
...
local function showTeams(t0, t1, t2)
	...
	local h_marineUnhappiness = unhappiness(t1, "marine")
	local h_alienUnhappiness = unhappiness(t2, "alien")
